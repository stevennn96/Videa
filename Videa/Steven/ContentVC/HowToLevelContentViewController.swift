...
class HowToLevelContentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        if tag == 1{
            titleImage.image = UIImage(named: "howtobeayoutuber")
            ...
            titleImage.image = UIImage(named: "howtobeablogger")
            ...
            titleImage.image = UIImage(named: "howtobeaselebgram")
            ...
            titleImage.image = UIImage(named: "howtomakeyourfavoritefood")
            titleLabel.text = "How to make your favorite food!"
            ...
            titleImage.image = UIImage(named: "howtomakeyourfavoriteindonesianfood")
            ...
            titleImage.image = UIImage(named: "howtomakeyourfavoritecake")
            titleLabel.text = "How to make your favorite Cake"
            description1Label.text = "Buatlah video tentang bagaimana cara kamu membuat kue kesukaan kamu! Kamu jangan asal buat kue nya yaa sebelumnya kamu harus melalkukan research bahan dan cara membuatnya setelah itru kamu pastikan dulu membuat dengan cara tersebut menghasilkan rasa yang kamu inginkan. Kamu juga nbisa tambahkan informasi – informasi tentang kue yang kamu buat contohnya kamu bisa jelaskan kue yang kamu buat asalnya dari mana, dan bisa varian rasa apa saja, dll."
            description2Label.text = "Good Luck!"
            getVideo(videoCode: "wI5gVEzrc_Q")
        } else if tag == 7{
            titleImage.image = UIImage(named: "howtomakeyourfavoritespicyfood")
            ...
            titleImage.image = UIImage(named: "howtostylelikeyourfavoritestyle")
            ...
            titleImage.image = UIImage(named: "howtomixandmatch")
            ...
            titleImage.image = UIImage(named: "howtobefashionstylish")
            titleLabel.text = "How to be Fashion Stylish"
            description1Label.text = "Fashion stylish adalah segala sesuatu yg berhubungan dengan trends mode dan segala perkembangannya dan kemajuannya mengenai model - model terbaru dari jenis baju , assesoris, make-up, shoes, bag, bagaimana memadu padankan, memilihnya dengan pas seperti corak baju yg sedang dipakai [serasi,sepadan tampil stylish] menampilkan karya -karya desainer yg cukup laku di pasaran dan diminati masyarakat, selain itu juga membuat kita/mereka yg belum mengerti menjadi tau apa itu model terbaru dari fashion stlylish yg lagi marak dan jadi idola dan laku serta pantas untuk mengikuti perkembangan saat ini."
            description2Label.text = "Good Luck!"
            getVideo(videoCode: "uQaCv38e89w")
        } else if tag == 11{
            titleImage.image = UIImage(named: "howtoloseweightfast")
            titleLabel.text = "How to Lose Weight Fast"
            description1Label.text = "Buatlah video kamu menceritakan pengalaman kamu atau informasi yang kamu tahu tentang bagaimana menurunkan berat badan dengan cepat. Kamu bisa menceritakan nya atau membuat vlog seakan-akan audience kamu juga merasakan apa yang kamu rasakan selama menurunkan berat badan."
            description2Label.text = "Good Luck!"
            getVideo(videoCode: "5IXPbd-G9vQ")
        } else if tag == 12{
            titleImage.image = UIImage(named: "howtolosebellyfat")
            titleLabel.text = "How to Lose Belly Fat"
            description1Label.text = "Buatlah video kamu memberikan tips and trick untuk mengecilkan perut. kamu bisa menceritakan nya taua lebih baik lagi kalau kamu memeragakan olahraga yang kamu lakukan selama mengecilkan perut dan dan memberikan tips makanan yang boleh dan tidak boleh dikonsumsi."
            description2Label.text = "Good Luck!"
            getVideo(videoCode: "FxYg29MpT90")
        } else if tag == 13{
            titleImage.image = UIImage(named: "howtoeathealthyfood")
            titleLabel.text = "How to Eat Healthy Food"
            description1Label.text = "Buatlah video kamu menyeritakan bagaimana mengkonsumsi makanan sehat, selain bagaimana kamu juga bisa menyeritakan dimana kamu membeli makanan tersebut, apa isi kandungan nya, dan seberapa efektifnya dengan mengkonsumsi makanan sehat dengan cara yang kamu tunjukan."
            description2Label.text = "Good Luck!"
            getVideo(videoCode: "ajtaXzGiwHY")
        } 
    }
