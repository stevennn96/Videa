...
class ComedyLevelContentViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        if tag == 1{
            titleImage.image = UIImage(named: "parodi")
            ...
            titleImage.image = UIImage(named: "comedyhorror")
            titleLabel.text = "Comedy Horror"
            description1Label.text = "Buatlah video bergenre comedy dan juga horror. Buatlah video bercerita seram dan juga lucu, buatlah suasana cerita menegangkan sekaligus menghibur. Buat sekreatif mungkin ya! kamu bisa tambah visual effect agar lebih menarik! Kamu juga bisa buat short movie"
            description2Label.text = "Tips: tambahkan karakter lucu atau pelawak untuk menghibur audience"
            getVideo(videoCode: "qkCRVwwuA40")
        } else if tag == 3{
            titleImage.image = UIImage(named: "comedyromance")
            ...
            titleImage.image = UIImage(named: "comedymotivasi")
            ...
            titleImage.image = UIImage(named: "vlog")
            ...
            titleImage.image = UIImage(named: "standupcomedy")
            ...
            titleImage.image = UIImage(named: "impersonatefamousperson")
            ...
            titleImage.image = UIImage(named: "dochallenge")
